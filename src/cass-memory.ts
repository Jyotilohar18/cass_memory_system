...
program.command("context")
  ...
  .option("--json", "Output JSON")
  .option("--top <n>", "Number of rules to show", parseInt)
  .option("--history <n>", "Number of history snippets", parseInt)
  .option("--days <n>", "Lookback days for history", parseInt)
...
program.command("reflect")
  ...
  .option("--days <n>", "Lookback days", parseInt)
  .option("--max-sessions <n>", "Max sessions to process", parseInt)
